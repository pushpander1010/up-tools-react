...
export default {
  async fetch(req, env) {
    ...
    const LEGACY_REDIRECTS = {
      ...
      '/percentage-calculator-pro/': '/percentage-calculator/',
      '/qr-code-generator-pro': '/qr-generator',
      '/qr-code-generator-pro/': '/qr-generator/',
      '/unit-converter-pro': '/unit-converter',
      '/unit-converter-pro/': '/unit-converter/',
      '/uuid-generator-pro': '/uuid-generator',
      '/uuid-generator-pro/': '/uuid-generator/',
      '/json-formatter-pro': '/json-formatter',
      '/json-formatter-pro/': '/json-formatter/',
      '/json-formatter-online': '/json-formatter',
      '/json-formatter-online/': '/json-formatter/',
      '/tool-401k-calculator': '/401k-calculator',
      '/tool-401k-calculator/': '/401k-calculator/',
      '/text-diff-checker': '/diff-checker',
      '/text-diff-checker/': '/diff-checker/',
      '/word-counter-enhanced': '/word-counter-plus',
      '/word-counter-enhanced/': '/word-counter-plus/',
      '/number-base-converter': '/binary-code-translator',
      '/number-base-converter/': '/binary-code-translator/',
      '/tip-calculator-pro': '/tip-calculator',
      '/tip-calculator-pro/': '/tip-calculator/',
      ...
      '/indian-flag-ascii-art/': '/indian-flag-generator/',
      // Games: flat /games-<name>/ slugs -> real nested /games/<name>/ URLs 2026-08-15
      '/games-battleship': '/games/battleship',
      '/games-battleship/': '/games/battleship/',
      '/games-bubble-shooter': '/games/bubble-shooter',
      '/games-bubble-shooter/': '/games/bubble-shooter/',
      '/games-coin-flip': '/games/coin-flip',
      '/games-coin-flip/': '/games/coin-flip/',
      '/games-dice-roller': '/games/dice-roller',
      '/games-dice-roller/': '/games/dice-roller/',
      '/games-friendship-test': '/games/friendship-test',
      '/games-friendship-test/': '/games/friendship-test/',
      '/games-hangman': '/games/hangman',
      '/games-hangman/': '/games/hangman/',
      '/games-love-test': '/games/love-test',
      '/games-love-test/': '/games/love-test/',
      '/games-pac-man': '/games/pac-man',
      '/games-pac-man/': '/games/pac-man/',
      '/games-ping-pong': '/games/ping-pong',
      '/games-ping-pong/': '/games/ping-pong/',
      '/games-quiz-trivia': '/games/quiz-trivia',
      '/games-quiz-trivia/': '/games/quiz-trivia/',
      '/games-super-sudoku': '/games/super-sudoku',
      '/games-super-sudoku/': '/games/super-sudoku/',
      '/games-typing-speed': '/games/typing-speed',
      '/games-typing-speed/': '/games/typing-speed/',
      '/games-wheel-of-names': '/games/wheel-of-names',
      '/games-wheel-of-names/': '/games/wheel-of-names/',
      '/games-word-scramble': '/games/word-scramble',
      '/games-word-scramble/': '/games/word-scramble/',
      '/games-frogger': '/games/frogger',
      '/games-frogger/': '/games/frogger/',
      '/games-hex-gl': '/games/hex-gl',
      '/games-hex-gl/': '/games/hex-gl/',
      ...
      '/games-sudoku/': '/games/sudoku/',
      '/games-connect-4': '/games/connect-4',
      '/games-connect-4/': '/games/connect-4/',
      ...
      '/games-2048/': '/games/2048/',
      '/games-reaction-time': '/games/reaction-time',
      '/games-reaction-time/': '/games/reaction-time/',
      '/games-flappy-bird': '/games/flappy-bird',
      '/games-flappy-bird/': '/games/flappy-bird/',
      '/games-number-guessing': '/games/number-guessing',
      '/games-number-guessing/': '/games/number-guessing/',
      '/games-chess': '/games/chess',
      '/games-chess/': '/games/chess/',
      '/games-minesweeper': '/games/minesweeper',
      '/games-minesweeper/': '/games/minesweeper/',
      '/games-wordle': '/games/wordle',
      '/games-wordle/': '/games/wordle/',
      '/games-memory-sequence': '/games/memory-sequence',
      '/games-memory-sequence/': '/games/memory-sequence/',
      '/games-solitaire': '/games/solitaire',
      '/games-solitaire/': '/games/solitaire/',
      '/games-simon-says': '/games/simon-says',
      '/games-simon-says/': '/games/simon-says/',
      '/games-memory-match': '/games/memory-match',
      '/games-memory-match/': '/games/memory-match/',
      '/games-color-rush': '/games/color-rush',
      '/games-color-rush/': '/games/color-rush/',
      '/games-whack-a-mole': '/games/whack-a-mole',
      '/games-whack-a-mole/': '/games/whack-a-mole/',
      '/games-doodle-jump': '/games/doodle-jump',
      '/games-doodle-jump/': '/games/doodle-jump/',
      '/games-snake': '/games/snake',
      '/games-snake/': '/games/snake/',
      '/games-tower-defense': '/games/tower-defense',
      '/games-tower-defense/': '/games/tower-defense/',
