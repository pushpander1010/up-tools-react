...
export default function net_worth_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate your total net worth: assets minus liabilities."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="net-worth-calculator"
      faq={[
        { q: "What is Net Worth Calculator?", a: "Net Worth Calculator is a free online tool by UpTools. Calculate your total net worth: assets minus liabilities." },
        { q: "How to use Net Worth Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Net Worth Calculator", "applicationCategory": "UtilitiesApplication",
