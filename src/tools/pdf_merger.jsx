...
export default function pdf_merger() {
  ...
  return (
    <ToolLayout
      title="PDF Merger"
      desc="Merge multiple PDF files online."
      icon="🔧" iconBg="rgba(245,158,11,0.08)"
      category="tools" slug="pdf-merger"
      faq={[
        { q: "What is PDF Merger?", a: "PDF Merger is a free online tool by UpTools. Merge multiple PDF files online." },
        { q: "How to use PDF Merger?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
