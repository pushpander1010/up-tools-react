...
export default function upi_qr_generator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Generate UPI QR codes for payments."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="upi-qr-generator"
      faq={[
        { q: "What is UPI QR Code Generator?", a: "UPI QR Code Generator is a free online tool by UpTools. Generate UPI QR codes for payments." },
        { q: "How to use UPI QR Code Generator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
