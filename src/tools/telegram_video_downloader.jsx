...
export default function telegram_video_downloader() {
  ...
  return (
    <ToolLayout
      ...
      desc="Download videos and media from Telegram channels and groups."
      icon="📱" iconBg="rgba(236,72,153,0.08)"
      category="social" slug="telegram-video-downloader"
      faq={[
        { q: "What is Telegram Video Downloader?", a: "Telegram Video Downloader is a free online tool by UpTools. Download videos and media from Telegram channels and groups." },
        { q: "How to use Telegram Video Downloader?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Telegram Video Downloader", "applicationCategory": "UtilitiesApplication",
