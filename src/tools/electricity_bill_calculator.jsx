...
export default function electricity_bill_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Estimate monthly power bill from units."
      icon="🇮🇳" iconBg="rgba(245,158,11,0.08)"
      category="india" slug="electricity-bill-calculator"
      faq={[
        { q: "What is Electricity Bill Calculator?", a: "Electricity Bill Calculator is a free online tool by UpTools. Estimate monthly power bill from units." },
        { q: "How to use Electricity Bill Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Electricity Bill Calculator", "applicationCategory": "UtilitiesApplication",
