...
export default function ai_linkedin_headline_generator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Create keyword-rich LinkedIn headlines for jobs, freelancing and founders."
      icon="🤖" iconBg="rgba(168,85,247,0.08)"
      category="ai" slug="ai-linkedin-headline-generator"
      faq={[
        { q: "What is AI LinkedIn Headline Generator?", a: "AI LinkedIn Headline Generator is a free online tool by UpTools. Create keyword-rich LinkedIn headlines for jobs, freelancing and founders." },
        { q: "How to use AI LinkedIn Headline Generator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
