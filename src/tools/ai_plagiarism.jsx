  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Check originality and paraphrase safely." />
        <link rel="canonical" href="https://www.uptools.in/ai-plagiarism/" />
        <meta property="og:title" content="AI Plagiarism Checker | UpTools" />
        <meta property="og:description" content="Check originality and paraphrase safely." />
      </Helmet>

      <nav className="text-xs text-slate-500 mb-4">
        <Link to="/" className="hover:text-white transition-colors">Home</Link>
        <span className="mx-2 text-slate-700">›</span>
        <span className="text-white">AI Plagiarism Checker</span>
      </nav>
      ...
      <section className="glass p-6 mb-6" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.08), rgba(17,24,39,0.6))', borderColor: 'rgba(99,102,241,0.2)' }}>
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-white m-0">AI Plagiarism Checker</h1>
            <p className="text-sm text-slate-400 mt-1">Check originality and paraphrase safely.</p>
          </div>
        </div>
