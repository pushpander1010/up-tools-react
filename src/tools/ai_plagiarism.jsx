...
export default function ai_plagiarism() {
  ...
  return (
    <ToolLayout
      ...
      desc="Check originality and paraphrase safely."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="ai-plagiarism"
      faq={[
        { q: "What is AI Plagiarism Checker?", a: "AI Plagiarism Checker is a free online tool by UpTools. Check originality and paraphrase safely." },
        { q: "How to use AI Plagiarism Checker?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
