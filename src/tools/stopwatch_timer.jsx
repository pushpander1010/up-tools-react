...
export default function stopwatch_timer() {
  ...
  return (
    <ToolLayout
      ...
      desc="Online stopwatch and countdown timer."
      icon="🔧" iconBg="rgba(245,158,11,0.08)"
      category="tools" slug="stopwatch-timer"
      faq={[
        { q: "What is Stopwatch & Timer?", a: "Stopwatch & Timer is a free online tool by UpTools. Online stopwatch and countdown timer." },
        { q: "How to use Stopwatch & Timer?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
