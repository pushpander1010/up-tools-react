...
export default function hra_calculator() {
  ...
  return (
    <ToolLayout
      ...
      faq={[
        { q: "What is HRA Exemption Calculator?", a: "HRA Exemption Calculator is a free online tool by UpTools. Calculate House Rent Allowance exemption." },
        { q: "How to use HRA Exemption Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "HRA Exemption Calculator", "applicationCategory": "UtilitiesApplication",
