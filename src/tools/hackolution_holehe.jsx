...
export default function hackolution_holehe() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/uOrcrIAsMIo/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/uOrcrIAsMIo" title="Holehe Tutorial — Check Your Email on 120+ Sites — HNCKER"
          ...
          <div className="flex gap-2 flex-wrap mt-3">
            <a href="https://www.youtube.com/watch?v=uOrcrIAsMIo" target="_blank" rel="noopener noreferrer"
  ...
  { i: "🔍", t: "Breach alerts", d: "Have I Been Pwned monitoring." },
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="Holehe in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/uOrcrIAsMIo/hqdefault.jpg" alt="holehe video tutorial thumbnail" width="480" height="360"
      ...
      <Section id="resources" icon="🔗" title="Resources" subtitle="Official links">
        <div className="space-y-2">
          {[["📚", "Holehe on GitHub", "https://github.com/megadose/holehe"], ["📖", "Have I Been Pwned", "https://haveibeenpwned.com/"], ["📸", "HACKOLUTION Instagram", "https://www.instagram.com/hackolution"]].map(([i, label, href]) => (
