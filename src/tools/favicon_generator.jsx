...
export default function favicon_generator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Create favicons from text or emoji."
      icon="⚙️" iconBg="rgba(6,182,212,0.08)"
      category="dev" slug="favicon-generator"
      faq={[
        { q: "What is Favicon Generator?", a: "Favicon Generator is a free online tool by UpTools. Create favicons from text or emoji." },
        { q: "How to use Favicon Generator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Favicon Generator", "applicationCategory": "UtilitiesApplication",
