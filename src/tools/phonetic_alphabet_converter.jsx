...
export default function phonetic_alphabet_converter() {
  ...
  return (
    <ToolLayout
      ...
      category="text" slug="phonetic-alphabet-converter"
      faq={[
        { q: "What is Phonetic Alphabet Converter?", a: "Phonetic Alphabet Converter is a free online tool by UpTools. Convert text to NATO phonetic alphabet." },
        { q: "How to use Phonetic Alphabet Converter?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
