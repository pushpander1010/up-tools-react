...
export default function quote_generator() {
  ...
  return (
    <ToolLayout
      ...
      desc="200+ inspiring quotes from famous people."
      icon="🎮" iconBg="rgba(244,63,94,0.08)"
      category="fun" slug="quote-generator"
      faq={[
        { q: "What is Quote Generator?", a: "Quote Generator is a free online tool by UpTools. 200+ inspiring quotes from famous people." },
        { q: "How to use Quote Generator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
