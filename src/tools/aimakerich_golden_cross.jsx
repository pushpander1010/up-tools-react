...
export default function aimakerich_golden_cross() {
  return (
    ...
    >
      ...
      <Section id="video" icon="🎬" title="Video Tutorial" subtitle="Watch the Golden Cross walkthrough">
        <div className="max-w-3xl mx-auto">
          <a href="https://www.youtube.com/watch?v=E5bpuTbkZ2s" target="_blank" rel="noopener noreferrer"
            className="block rounded-xl overflow-hidden border border-white/10 no-underline"
            style={{ background: '#000' }}>
            <div className="aspect-video w-full overflow-hidden relative">
              <img src="https://i.ytimg.com/vi/E5bpuTbkZ2s/hqdefault.jpg"
                alt="Golden Cross Strategy — MA50 x MA200 crossover" loading="lazy"
              ...
              <div className="absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                <p className="text-sm font-semibold text-white">Golden Cross — MA50 × MA200, spot the start of an uptrend</p>
              </div>
            </div>
          </a>
        </div>
