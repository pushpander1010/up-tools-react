...
export default function stamp_duty_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate UK Stamp Duty Land Tax on property."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="stamp-duty-calculator"
      faq={[
        { q: "What is UK Stamp Duty Calculator?", a: "UK Stamp Duty Calculator is a free online tool by UpTools. Calculate UK Stamp Duty Land Tax on property." },
        { q: "How to use UK Stamp Duty Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "UK Stamp Duty Calculator", "applicationCategory": "UtilitiesApplication",
