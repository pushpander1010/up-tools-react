...
export default function hackolution_sqlmap() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/M6Ayf2vQusg/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/M6Ayf2vQusg" title="SQLMap Full Tutorial — Database Hacking Explained — HNCKER"
          ...
          <div className="flex gap-2 flex-wrap mt-3">
            <a href="https://www.youtube.com/watch?v=M6Ayf2vQusg" target="_blank" rel="noopener noreferrer"
  ...
  { i: "👁️", t: "Log + alert", d: "Alert on UNION/SELECT probe patterns." },
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="SQLMap in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/M6Ayf2vQusg/hqdefault.jpg" alt="sqlmap video tutorial thumbnail" width="480" height="360"
      ...
      <Section id="resources" icon="🔗" title="Resources" subtitle="Official links">
        <div className="space-y-2">
          {[["📚", "Official SQLMap wiki", "https://github.com/sqlmapproject/sqlmap/wiki"], ["📖", "DVWA lab app", "http://www.dvwa.co.uk/"], ["📸", "HACKOLUTION Instagram", "https://www.instagram.com/hackolution"]].map(([i, label, href]) => (
