...
export default function aimakerich_rsi_macd_divergence() {
  return (
    ...
    >
      ...
      <Section id="video" icon="🎬" title="Video Tutorial" subtitle="Watch the RSI + MACD Divergence walkthrough">
        <div className="max-w-3xl mx-auto">
          <a href="https://www.youtube.com/watch?v=548gmQT_BYA" target="_blank" rel="noopener noreferrer"
            className="block rounded-xl overflow-hidden border border-white/10 no-underline"
            style={{ background: '#000' }}>
            <div className="aspect-video w-full overflow-hidden relative">
              <img src="https://i.ytimg.com/vi/548gmQT_BYA/hqdefault.jpg"
                alt="RSI + MACD Divergence Strategy — spot reversals early" loading="lazy"
              ...
              <div className="absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                <p className="text-sm font-semibold text-white">RSI + MACD Divergence — spot reversals before the move</p>
              </div>
            </div>
          </a>
        </div>
