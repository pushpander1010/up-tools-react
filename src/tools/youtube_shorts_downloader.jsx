...
export default function youtube_shorts_downloader() {
  ...
  return (
    <ToolLayout
      ...
      desc="Download YouTube Shorts free."
      icon="📱" iconBg="rgba(236,72,153,0.08)"
      category="social" slug="youtube-shorts-downloader"
      faq={[
        { q: "What is YouTube Shorts Downloader?", a: "YouTube Shorts Downloader is a free online tool by UpTools. Download YouTube Shorts free." },
        { q: "How to use YouTube Shorts Downloader?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "YouTube Shorts Downloader", "applicationCategory": "UtilitiesApplication",
