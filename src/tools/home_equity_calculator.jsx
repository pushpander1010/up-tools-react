...
export default function home_equity_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate equity in your home and track growth."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="home-equity-calculator"
      faq={[
        { q: "What is Home Equity Calculator?", a: "Home Equity Calculator is a free online tool by UpTools. Calculate equity in your home and track growth." },
        { q: "How to use Home Equity Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Home Equity Calculator", "applicationCategory": "UtilitiesApplication",
