      ...
      <Section id="video" icon="🎬" title="Video Tutorial" subtitle="Learn it on the HACKOLUTION channel">
        <div className="max-w-3xl mx-auto">
          ...
          <a href="https://www.instagram.com/hackolution" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-4 rounded-xl overflow-hidden border border-white/10 no-underline p-5 mt-3 hover:border-neon/40 transition-all"
            ...
            <div>
              <p className="text-sm font-semibold text-white m-0">Wireshark — Packet Sniffer reel</p>
