...
export default function hackolution_wireshark() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/qeMPvVaS7vQ/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/qeMPvVaS7vQ" title="Wireshark Full Tutorial — Capture and Analyze Packets — HNCKER"
          ...
          <div className="flex gap-2 flex-wrap mt-3">
            <a href="https://www.youtube.com/watch?v=qeMPvVaS7vQ" target="_blank" rel="noopener noreferrer"
  ...
  { i: "👁️", t: "Watch DNS", d: "Plain DNS leaks every domain." },
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="Wireshark in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/qeMPvVaS7vQ/hqdefault.jpg" alt="wireshark video tutorial thumbnail" width="480" height="360"
      ...
      <Section id="resources" icon="🔗" title="Resources" subtitle="Official links">
        <div className="space-y-2">
          {[["📚", "Official Wireshark docs", "https://www.wireshark.org/docs/"], ["📖", "Display filter reference", "https://www.wireshark.org/docs/dfref/"], ["📸", "HACKOLUTION Instagram", "https://www.instagram.com/hackolution"]].map(([i, label, href]) => (
