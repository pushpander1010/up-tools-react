...
export default function snapchat_filters_guide() {
  ...
  return (
    <ToolLayout
      ...
      desc="Complete guide to using Snapchat filters and lenses."
      icon="📱" iconBg="rgba(236,72,153,0.08)"
      category="social" slug="snapchat-filters-guide"
      faq={[
        { q: "What is Snapchat Filters Guide?", a: "Snapchat Filters Guide is a free online tool by UpTools. Complete guide to using Snapchat filters and lenses." },
        { q: "How to use Snapchat Filters Guide?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Snapchat Filters Guide", "applicationCategory": "UtilitiesApplication",
