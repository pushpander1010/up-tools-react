...
export default function fantasy_sports_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate fantasy points for cricket, football, basketball and more. Dream11 points."
      icon="🏆" iconBg="rgba(59,130,246,0.08)"
      category="sports" slug="fantasy-sports-calculator"
      faq={[
        { q: "What is Fantasy Sports Calculator?", a: "Fantasy Sports Calculator is a free online tool by UpTools. Calculate fantasy points for cricket, football, basketball and more. Dream11 points." },
        { q: "How to use Fantasy Sports Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
