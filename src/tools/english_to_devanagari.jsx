...
export default function english_to_devanagari() {
  ...
  return (
    <ToolLayout
      ...
      desc="Convert English (Roman) text to Devanagari (Hindi) script instantly. Phonetic transliterator — no signup."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="english-to-devanagari"
      faq={[
        { q: "What is English to Devanagari?", a: "English to Devanagari is a free online tool by UpTools. Convert English (Roman) text to Devanagari (Hindi) script instantly. Phonetic transliterator — no signup." },
        { q: "How to use English to Devanagari?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "English to Devanagari", "applicationCategory": "UtilitiesApplication",
