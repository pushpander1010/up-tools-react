...
export default function snapchat_story_ideas() {
  ...
  return (
    <ToolLayout
      ...
      desc="Generate creative story ideas for Snapchat."
      icon="📱" iconBg="rgba(236,72,153,0.08)"
      category="social" slug="snapchat-story-ideas"
      faq={[
        { q: "What is Snapchat Story Ideas Generator?", a: "Snapchat Story Ideas Generator is a free online tool by UpTools. Generate creative story ideas for Snapchat." },
        { q: "How to use Snapchat Story Ideas Generator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
