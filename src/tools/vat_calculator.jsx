...
export default function vat_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate European VAT for all EU countries and rates."
      icon="📋" iconBg="rgba(245,158,11,0.08)"
      category="tax" slug="vat-calculator"
      faq={[
        { q: "What is VAT Calculator?", a: "VAT Calculator is a free online tool by UpTools. Calculate European VAT for all EU countries and rates." },
        { q: "How to use VAT Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "VAT Calculator", "applicationCategory": "UtilitiesApplication",
