...
export default function sports_score_converter() {
  ...
  return (
    <ToolLayout
      ...
      category="sports" slug="sports-score-converter"
      faq={[
        { q: "What is Sports Score Converter?", a: "Sports Score Converter is a free online tool by UpTools. Convert scores between different sports formats and scoring systems." },
        { q: "How to use Sports Score Converter?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
