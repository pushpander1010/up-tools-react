...
export default function pdf_splitter() {
  ...
  return (
    <ToolLayout
      title="PDF Splitter"
      desc="Split PDF files into pages."
      icon="🔧" iconBg="rgba(245,158,11,0.08)"
      category="tools" slug="pdf-splitter"
      faq={[
        { q: "What is PDF Splitter?", a: "PDF Splitter is a free online tool by UpTools. Split PDF files into pages." },
        { q: "How to use PDF Splitter?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
