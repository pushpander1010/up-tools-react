...
export default function ipl_fantasy_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate Dream11 fantasy points for batting, bowling and fielding."
      icon="🏏" iconBg="rgba(59,130,246,0.08)"
      category="cricket" slug="ipl-fantasy-calculator"
      faq={[
        { q: "What is IPL Fantasy Points Calculator?", a: "IPL Fantasy Points Calculator is a free online tool by UpTools. Calculate Dream11 fantasy points for batting, bowling and fielding." },
        { q: "How to use IPL Fantasy Points Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "IPL Fantasy Points Calculator", "applicationCategory": "UtilitiesApplication",
