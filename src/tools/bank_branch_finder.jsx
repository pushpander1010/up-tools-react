...
export default function bank_branch_finder() {
  ...
  return (
    <ToolLayout
      ...
      desc="Find bank branches, ATMs, and contact details in your city."
      icon="🏦" iconBg="rgba(99,102,241,0.08)"
      category="banking" slug="bank-branch-finder"
      faq={[
        { q: "What is Bank Branch Finder?", a: "Bank Branch Finder is a free online tool by UpTools. Find bank branches, ATMs, and contact details in your city." },
        { q: "How to use Bank Branch Finder?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Bank Branch Finder", "applicationCategory": "UtilitiesApplication",
