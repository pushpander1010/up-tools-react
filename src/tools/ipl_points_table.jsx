...
export default function ipl_points_table() {
  ...
  return (
    <ToolLayout
      ...
      desc="Live IPL standings with NRR, wins, losses and playoff tracker."
      icon="🏏" iconBg="rgba(59,130,246,0.08)"
      category="cricket" slug="ipl-points-table"
      faq={[
        { q: "What is IPL 2025 Points Table?", a: "IPL 2025 Points Table is a free online tool by UpTools. Live IPL standings with NRR, wins, losses and playoff tracker." },
        { q: "How to use IPL 2025 Points Table?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "IPL 2025 Points Table", "applicationCategory": "UtilitiesApplication",
