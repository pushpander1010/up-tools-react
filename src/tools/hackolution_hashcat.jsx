...
export default function hackolution_hashcat() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/wB-Jvz__0B4/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/wB-Jvz__0B4" title="Hashcat Tutorial — Crack Passwords with GPU — HNCKER"
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
            <iframe
              ...
              title="Hashcat Password Cracking - Demo | HACKOLUTION"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            />
          </div>
...
# [STATUS] exhausted wordlist`} />
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="Hashcat in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/wB-Jvz__0B4/hqdefault.jpg" alt="hashcat video tutorial thumbnail" width="480" height="360"
