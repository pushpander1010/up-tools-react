...
export default function ai_name_generator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Generate baby, business, brand & character names."
      icon="🤖" iconBg="rgba(168,85,247,0.08)"
      category="ai" slug="ai-name-generator"
      faq={[
        { q: "What is AI Name Generator?", a: "AI Name Generator is a free online tool by UpTools. Generate baby, business, brand & character names." },
        { q: "How to use AI Name Generator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
