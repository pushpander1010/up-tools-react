...
export default function hackolution_metasploit() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/ZNo_K3bMIZo/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/ZNo_K3bMIZo" title="How to Use Metasploit: Beginner to Pro Guide — HNCKER"
          ...
          <div className="flex gap-2 flex-wrap mt-3">
            <a href="https://www.youtube.com/watch?v=ZNo_K3bMIZo" target="_blank" rel="noopener noreferrer"
  ...
  { i: "💾", t: "Backups", d: "Tested restores beat ransom." },
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="Metasploit in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/ZNo_K3bMIZo/hqdefault.jpg" alt="metasploit video tutorial thumbnail" width="480" height="360"
      ...
      <Section id="resources" icon="🔗" title="Resources" subtitle="Official links">
        <div className="space-y-2">
          {[["📚", "Metasploit docs", "https://docs.metasploit.com/"], ["📖", "Metasploitable 2", "https://docs.rapid7.com/metasploit/metasploitable-2/"], ["📸", "HACKOLUTION Instagram", "https://www.instagram.com/hackolution"]].map(([i, label, href]) => (
