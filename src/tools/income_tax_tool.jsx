...
export default function income_tax_tool() {
  return (
    <>
      <Helmet>
        <title>Income Tax Calculator | UpTools</title>
        <meta name="description" content="Estimate income tax quickly." />
        <link rel="canonical" href="https://www.uptools.in/income-tax-tool/" />
        <meta property="og:title" content="Income Tax Calculator | UpTools" />
        <meta property="og:description" content="Estimate income tax quickly." />
      </Helmet>
      ...
      <section className="glass p-6 mb-6" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.08), rgba(17,24,39,0.6))', borderColor: 'rgba(99,102,241,0.2)' }}>
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">Estimate income tax quickly.</p>
          </div>
        </div>
      ...
      <iframe
        src="/income-tax-tool/index.html"
