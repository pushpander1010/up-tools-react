...
export default function ovulation_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate ovulation date and fertility window."
      icon="❤️" iconBg="rgba(239,68,68,0.08)"
      category="health" slug="ovulation-calculator"
      faq={[
        { q: "What is Ovulation Calculator?", a: "Ovulation Calculator is a free online tool by UpTools. Calculate ovulation date and fertility window." },
        { q: "How to use Ovulation Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Ovulation Calculator", "applicationCategory": "UtilitiesApplication",
