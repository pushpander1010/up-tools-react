...
export default function ai_youtube_script() {
  ...
  return (
    <ToolLayout
      ...
      desc="Write retention-optimized YouTube scripts with AI."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="ai-youtube-script"
      faq={[
        { q: "What is AI YouTube Script Writer?", a: "AI YouTube Script Writer is a free online tool by UpTools. Write retention-optimized YouTube scripts with AI." },
        { q: "How to use AI YouTube Script Writer?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
