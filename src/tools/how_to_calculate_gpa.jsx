...
export default function how_to_calculate_gpa() {
  ...
  return (
    <ToolLayout
      ...
      desc="Step-by-step GPA & CGPA calculation guide."
      icon="📚" iconBg="rgba(59,130,246,0.08)"
      category="study" slug="how-to-calculate-gpa"
      faq={[
        { q: "What is How to Calculate GPA?", a: "How to Calculate GPA is a free online tool by UpTools. Step-by-step GPA & CGPA calculation guide." },
        { q: "How to use How to Calculate GPA?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "How to Calculate GPA", "applicationCategory": "UtilitiesApplication",
