...
export default function tds_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="TDS on salary, rent & interest."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="tds-calculator"
      faq={[
        { q: "What is TDS Calculator?", a: "TDS Calculator is a free online tool by UpTools. TDS on salary, rent & interest." },
        { q: "How to use TDS Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "TDS Calculator", "applicationCategory": "UtilitiesApplication",
