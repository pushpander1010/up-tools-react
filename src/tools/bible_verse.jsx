...
export default function bible_verse() {
  ...
  return (
    <ToolLayout
      ...
      desc="Look up scripture in KJV, ASV, WEB translations."
      icon="🔧" iconBg="rgba(245,158,11,0.08)"
      category="tools" slug="bible-verse"
      faq={[
        { q: "What is Bible Verse Lookup?", a: "Bible Verse Lookup is a free online tool by UpTools. Look up scripture in KJV, ASV, WEB translations." },
        { q: "How to use Bible Verse Lookup?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Bible Verse Lookup", "applicationCategory": "UtilitiesApplication",
