...
export default function resume_analyzer() {
  ...
  return (
    <ToolLayout
      ...
      desc="ATS score your resume against any JD."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="resume-analyzer"
      faq={[
        { q: "What is AI Resume Analyzer?", a: "AI Resume Analyzer is a free online tool by UpTools. ATS score your resume against any JD." },
        { q: "How to use AI Resume Analyzer?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "AI Resume Analyzer", "applicationCategory": "UtilitiesApplication",
