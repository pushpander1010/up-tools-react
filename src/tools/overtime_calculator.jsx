...
export default function overtime_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Estimate overtime pay with custom hourly rates and multipliers."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="overtime-calculator"
      faq={[
        { q: "What is Overtime Calculator?", a: "Overtime Calculator is a free online tool by UpTools. Estimate overtime pay with custom hourly rates and multipliers." },
        { q: "How to use Overtime Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Overtime Calculator", "applicationCategory": "UtilitiesApplication",
