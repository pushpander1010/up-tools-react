...
export default function todo_list_maker() {
  ...
  return (
    <ToolLayout
      ...
      desc="Simple online todo list with local storage."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="todo-list-maker"
      faq={[
        { q: "What is Todo List Maker?", a: "Todo List Maker is a free online tool by UpTools. Simple online todo list with local storage." },
        { q: "How to use Todo List Maker?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Todo List Maker", "applicationCategory": "UtilitiesApplication",
