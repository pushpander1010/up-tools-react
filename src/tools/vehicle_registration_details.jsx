...
export default function vehicle_registration_details() {
  ...
  return (
    <ToolLayout
      ...
      desc="Select country and open the official registration portal."
      icon="🔒" iconBg="rgba(239,68,68,0.08)"
      category="security" slug="vehicle-registration-details"
      faq={[
        { q: "What is Vehicle Registration Details?", a: "Vehicle Registration Details is a free online tool by UpTools. Select country and open the official registration portal." },
        { q: "How to use Vehicle Registration Details?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
