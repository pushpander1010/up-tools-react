...
export default function speed_test() {
  ...
  return (
    <ToolLayout
      ...
      desc="Measure download, upload speed & ping."
      icon="🌐" iconBg="rgba(14,165,233,0.08)"
      category="networking" slug="speed-test"
      faq={[
        { q: "What is Internet Speed Test?", a: "Internet Speed Test is a free online tool by UpTools. Measure download, upload speed & ping." },
        { q: "How to use Internet Speed Test?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
