...
export default function college_course_finder() {
  ...
  return (
    <ToolLayout
      ...
      desc="Find suitable college courses after 12th based on stream and interests."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="college-course-finder"
      faq={[
        { q: "What is College Course Finder?", a: "College Course Finder is a free online tool by UpTools. Find suitable college courses after 12th based on stream and interests." },
        { q: "How to use College Course Finder?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "College Course Finder", "applicationCategory": "UtilitiesApplication",
