...
export default function exif_tool() {
  ...
  return (
    <ToolLayout
      title="EXIF Tool"
      desc="Inspect, clean or embed photo metadata."
      icon="🖼️" iconBg="rgba(168,85,247,0.08)"
      category="images" slug="exif-tool"
      faq={[
        { q: "What is EXIF Tool?", a: "EXIF Tool is a free online tool by UpTools. Inspect, clean or embed photo metadata." },
        { q: "How to use EXIF Tool?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "EXIF Tool", "applicationCategory": "UtilitiesApplication",
