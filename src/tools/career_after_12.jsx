...
export default function career_after_12() {
  ...
  return (
    <ToolLayout
      ...
      desc="Discover career paths, streams, and courses after Class 12."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="career-after-12"
      faq={[
        { q: "What is Career Path After 12?", a: "Career Path After 12 is a free online tool by UpTools. Discover career paths, streams, and courses after Class 12." },
        { q: "How to use Career Path After 12?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Career Path After 12", "applicationCategory": "UtilitiesApplication",
