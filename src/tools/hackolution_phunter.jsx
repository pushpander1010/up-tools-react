...
export default function hackolution_phunter() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/toMN_jHJPX4/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/toMN_jHJPX4" title="Phunter Tutorial — Look Up Anything Behind a Phone Number — HNCKER"
...
pip3 install -r requirements.txt`} />
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshots" subtitle="Phunter in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/toMN_jHJPX4/hqdefault.jpg" alt="phunter video tutorial thumbnail" width="480" height="360"
