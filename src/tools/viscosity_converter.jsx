...
export default function viscosity_converter() {
  ...
  return (
    <ToolLayout
      ...
      desc="Convert viscosity units: Centipoise, Stokes, Pa·s."
      icon="⚙️" iconBg="rgba(6,182,212,0.08)"
      category="dev" slug="viscosity-converter"
      faq={[
        { q: "What is Viscosity Converter?", a: "Viscosity Converter is a free online tool by UpTools. Convert viscosity units: Centipoise, Stokes, Pa·s." },
        { q: "How to use Viscosity Converter?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
