...
export default function lunar_calendar() {
  ...
  return (
    <ToolLayout
      ...
      desc="View lunar calendar with moon phases and zodiac."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="lunar-calendar"
      faq={[
        { q: "What is Lunar Calendar?", a: "Lunar Calendar is a free online tool by UpTools. View lunar calendar with moon phases and zodiac." },
        { q: "How to use Lunar Calendar?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
