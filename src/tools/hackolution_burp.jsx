...
export default function hackolution_burp() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/iy_QW4_y9O4/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/iy_QW4_y9O4" title="Burp Suite Tutorial — Web App Security Testing — HNCKER"
          ...
          <div className="flex gap-2 flex-wrap mt-3">
            <a href="https://www.youtube.com/watch?v=iy_QW4_y9O4" target="_blank" rel="noopener noreferrer"
  ...
  { i: "📋", t: "Server checks", d: "Never trust client-side validation." },
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="Burp Suite in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/iy_QW4_y9O4/hqdefault.jpg" alt="burp video tutorial thumbnail" width="480" height="360"
      ...
      <Section id="resources" icon="🔗" title="Resources" subtitle="Official links">
        <div className="space-y-2">
          {[["📚", "PortSwigger Academy (free labs)", "https://portswigger.net/web-security"], ["📖", "Burp docs", "https://portswigger.net/burp/documentation"], ["📸", "HACKOLUTION Instagram", "https://www.instagram.com/hackolution"]].map(([i, label, href]) => (
