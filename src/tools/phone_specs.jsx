...
export default function phone_specs() {
  ...
  return (
    <ToolLayout
      ...
      desc="Search & compare phone specs side by side."
      icon="🔧" iconBg="rgba(245,158,11,0.08)"
      category="tools" slug="phone-specs"
      faq={[
        { q: "What is Phone Specifications?", a: "Phone Specifications is a free online tool by UpTools. Search & compare phone specs side by side." },
        { q: "How to use Phone Specifications?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
