...
export default function scientific_calculator() {
  ...
  return (
    <ToolLayout
      ...
      faq={[
        { q: "What is Scientific Calculator?", a: "Scientific Calculator is a free online tool by UpTools. Full-featured scientific calculator." },
        { q: "How to use Scientific Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
