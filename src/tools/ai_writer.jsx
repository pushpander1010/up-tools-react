...
export default function ai_writer() {
  ...
  return (
    <ToolLayout
      ...
      desc="Draft posts with Perplexity, Gemini & Groq."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="ai-writer"
      faq={[
        { q: "What is AI Writing Assistant?", a: "AI Writing Assistant is a free online tool by UpTools. Draft posts with Perplexity, Gemini & Groq." },
        { q: "How to use AI Writing Assistant?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
