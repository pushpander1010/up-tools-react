...
export default function hackolution_hydra() {
  return (
    <ToolLayout
  ...
  { i: "🔑", t: "Key-only SSH", d: "Disable PasswordAuthentication." },
      ...
      <Section id="resources" icon="🔗" title="Resources" subtitle="Official links">
        <div className="space-y-2">
          {[["📚", "THC-Hydra on GitHub", "https://github.com/vanhauser-thc/thc-hydra"], ["📖", "Metasploitable 2", "https://docs.rapid7.com/metasploit/metasploitable-2/"], ["📸", "HACKOLUTION Instagram", "https://www.instagram.com/hackolution"]].map(([i, label, href]) => (
