...
export default function pomodoro_timer() {
  ...
  return (
    <ToolLayout
      ...
      desc="Focus timer with work & break cycles."
      icon="🔧" iconBg="rgba(245,158,11,0.08)"
      category="tools" slug="pomodoro-timer"
      faq={[
        { q: "What is Pomodoro Timer?", a: "Pomodoro Timer is a free online tool by UpTools. Focus timer with work & break cycles." },
        { q: "How to use Pomodoro Timer?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
