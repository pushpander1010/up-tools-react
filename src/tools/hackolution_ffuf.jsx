...
export default function hackolution_ffuf() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/H8dwJpti6jg/hqdefault.jpg" />
      </Helmet>
...
# [FOUND] admin:letmein`} />
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="ffuf in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/H8dwJpti6jg/hqdefault.jpg" alt="ffuf discovering hidden web paths" width="480" height="360"
