...
export default function ai_stock_analyzer() {
  ...
  return (
    <ToolLayout
      ...
      desc="AI verdicts with charts and sentiment."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="ai-stock-analyzer"
      faq={[
        { q: "What is AI Stock Analyzer?", a: "AI Stock Analyzer is a free online tool by UpTools. AI verdicts with charts and sentiment." },
        { q: "How to use AI Stock Analyzer?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "AI Stock Analyzer", "applicationCategory": "UtilitiesApplication",
