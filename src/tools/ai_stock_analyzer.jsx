...
export default function ai_stock_analyzer() {
  return (
    <>
      <Helmet>
        <title>AI Stock Analyzer | UpTools</title>
        <meta name="description" content="AI verdicts with charts and sentiment." />
        <link rel="canonical" href="https://www.uptools.in/ai-stock-analyzer/" />
        <meta property="og:title" content="AI Stock Analyzer | UpTools" />
        <meta property="og:description" content="AI verdicts with charts and sentiment." />
      </Helmet>

      <nav className="text-xs text-slate-500 mb-4">
        <Link to="/" className="hover:text-white transition-colors">Home</Link>
        <span className="mx-2 text-slate-700">›</span>
        <span className="text-white">AI Stock Analyzer</span>
      </nav>
      ...
      <section className="glass p-6 mb-6" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.08), rgba(17,24,39,0.6))', borderColor: 'rgba(99,102,241,0.2)' }}>
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-white m-0">AI Stock Analyzer</h1>
            <p className="text-sm text-slate-400 mt-1">AI verdicts with charts and sentiment.</p>
          </div>
        </div>
      ...
      <iframe
        src="/ai-stock-analyzer/index.html"
