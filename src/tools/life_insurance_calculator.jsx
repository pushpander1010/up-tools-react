...
export default function life_insurance_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate how much life insurance coverage you need."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="life-insurance-calculator"
      faq={[
        { q: "What is Life Insurance Calculator?", a: "Life Insurance Calculator is a free online tool by UpTools. Calculate how much life insurance coverage you need." },
        { q: "How to use Life Insurance Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Life Insurance Calculator", "applicationCategory": "UtilitiesApplication",
