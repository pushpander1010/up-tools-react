...
export default function hackolution_sherlock() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/3j50uaM7bx4/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/3j50uaM7bx4" title="Sherlock Tutorial — Find a Username on 400+ Sites — HNCKER"
          ...
          <div className="flex gap-2 flex-wrap mt-3">
            <a href="https://www.youtube.com/watch?v=3j50uaM7bx4" target="_blank" rel="noopener noreferrer"
  ...
  { i: "👁️", t: "Self-search", d: "What Sherlock finds, others find." },
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="Sherlock in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/3j50uaM7bx4/hqdefault.jpg" alt="sherlock video tutorial thumbnail" width="480" height="360"
      ...
      <Section id="resources" icon="🔗" title="Resources" subtitle="Official links">
        <div className="space-y-2">
          {[["📚", "Sherlock on GitHub", "https://github.com/sherlock-project/sherlock"], ["📖", "Site list", "https://github.com/sherlock-project/sherlock#readme"], ["📸", "HACKOLUTION Instagram", "https://www.instagram.com/hackolution"]].map(([i, label, href]) => (
