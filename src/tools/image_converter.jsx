...
export default function image_converter() {
  ...
  return (
    <ToolLayout
      ...
      desc="Resize, crop and change image formats."
      icon="🖼️" iconBg="rgba(168,85,247,0.08)"
      category="images" slug="image-converter"
      faq={[
        { q: "What is Image Converter?", a: "Image Converter is a free online tool by UpTools. Resize, crop and change image formats." },
        { q: "How to use Image Converter?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Image Converter", "applicationCategory": "UtilitiesApplication",
