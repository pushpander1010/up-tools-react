...
export default function ifsc_bulk_lookup() {
  ...
  return (
    <ToolLayout
      ...
      desc="Search multiple IFSC codes at once. Download as CSV."
      icon="🏦" iconBg="rgba(99,102,241,0.08)"
      category="banking" slug="ifsc-bulk-lookup"
      faq={[
        { q: "What is IFSC Bulk Lookup?", a: "IFSC Bulk Lookup is a free online tool by UpTools. Search multiple IFSC codes at once. Download as CSV." },
        { q: "How to use IFSC Bulk Lookup?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "IFSC Bulk Lookup", "applicationCategory": "UtilitiesApplication",
