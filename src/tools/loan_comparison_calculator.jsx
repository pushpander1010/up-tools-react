...
export default function loan_comparison_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Compare two loans: EMI, interest & total."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="loan-comparison-calculator"
      faq={[
        { q: "What is Loan Comparison Calculator?", a: "Loan Comparison Calculator is a free online tool by UpTools. Compare two loans: EMI, interest & total." },
        { q: "How to use Loan Comparison Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Loan Comparison Calculator", "applicationCategory": "UtilitiesApplication",
