...
export default function games_hangman() {
  return (
    <>
      <Helmet>
        <title>Hangman | UpTools</title>
        <meta name="description" content="Classic word guessing game." />
        <link rel="canonical" href="https://www.uptools.in/games/hangman/" />
        <meta property="og:title" content="Hangman | UpTools" />
        <meta property="og:description" content="Classic word guessing game." />
      </Helmet>
      ...
      <section className="glass p-6 mb-6" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.08), rgba(17,24,39,0.6))', borderColor: 'rgba(99,102,241,0.2)' }}>
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-white m-0">Hangman</h1>
            <p className="text-sm text-slate-400 mt-1">Classic word guessing game.</p>
          </div>
        </div>
