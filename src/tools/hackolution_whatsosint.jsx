...
export default function hackolution_whatsosint() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/VZK6huQ0NvQ/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/VZK6huQ0NvQ" title="WhatsOSINT Tutorial — Check if a Number Is on WhatsApp — HNCKER"
...
[OK] Photo + status pulled`} />
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshots" subtitle="WhatsOSINT in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/VZK6huQ0NvQ/hqdefault.jpg" alt="whatsosint video tutorial thumbnail" width="480" height="360"
