...
export default function savings_goal_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate how long to reach your savings goal."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="savings-goal-calculator"
      faq={[
        { q: "What is Savings Goal Calculator?", a: "Savings Goal Calculator is a free online tool by UpTools. Calculate how long to reach your savings goal." },
        { q: "How to use Savings Goal Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Savings Goal Calculator", "applicationCategory": "UtilitiesApplication",
