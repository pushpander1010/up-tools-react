...
export default function youtube_video_downloader() {
  ...
  return (
    <ToolLayout
      ...
      desc="Download YouTube videos and audio in HD."
      icon="📱" iconBg="rgba(236,72,153,0.08)"
      category="social" slug="youtube-video-downloader"
      faq={[
        { q: "What is YouTube Video Downloader?", a: "YouTube Video Downloader is a free online tool by UpTools. Download YouTube videos and audio in HD." },
        { q: "How to use YouTube Video Downloader?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
