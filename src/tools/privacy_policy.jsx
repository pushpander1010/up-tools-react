...
export default function privacy_policy() {
  ...
  return (
    <ToolLayout
      ...
      desc="Understand how UpTools handles data."
      icon="🔒" iconBg="rgba(239,68,68,0.08)"
      category="security" slug="privacy-policy"
      faq={[
        { q: "What is Privacy Policy?", a: "Privacy Policy is a free online tool by UpTools. Understand how UpTools handles data." },
        { q: "How to use Privacy Policy?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Privacy Policy", "applicationCategory": "UtilitiesApplication",
