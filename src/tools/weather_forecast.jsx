...
export default function weather_forecast() {
  ...
  return (
    <ToolLayout
      ...
      desc="7-day forecast & hourly weather for any city."
      icon="🔧" iconBg="rgba(245,158,11,0.08)"
      category="tools" slug="weather-forecast"
      faq={[
        { q: "What is Weather Forecast?", a: "Weather Forecast is a free online tool by UpTools. 7-day forecast & hourly weather for any city." },
        { q: "How to use Weather Forecast?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
