...
export default function house_affordability_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate how much house you can afford based on income."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="house-affordability-calculator"
      faq={[
        { q: "What is House Affordability Calculator?", a: "House Affordability Calculator is a free online tool by UpTools. Calculate how much house you can afford based on income." },
        { q: "How to use House Affordability Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "House Affordability Calculator", "applicationCategory": "UtilitiesApplication",
