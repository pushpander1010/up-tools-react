...
export default function sip_calculator() {
  return (
    <>
      <Helmet>
        <title>SIP Calculator | UpTools</title>
        <meta name="description" content="Project SIP returns and wealth." />
        <link rel="canonical" href="https://www.uptools.in/sip-calculator/" />
        <meta property="og:title" content="SIP Calculator | UpTools" />
        <meta property="og:description" content="Project SIP returns and wealth." />
      </Helmet>
      ...
      <section className="glass p-6 mb-6" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.08), rgba(17,24,39,0.6))', borderColor: 'rgba(99,102,241,0.2)' }}>
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-white m-0">SIP Calculator</h1>
            <p className="text-sm text-slate-400 mt-1">Project SIP returns and wealth.</p>
          </div>
        </div>
