...
export default function ai_top10_stocks() {
  ...
  return (
    <ToolLayout
      ...
      desc="Tomorrow\'s AI-picked trading ideas."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="ai-top10-stocks"
      faq={[
        { q: "What is AI Top 10 Stocks?", a: "AI Top 10 Stocks is a free online tool by UpTools. Tomorrow\'s AI-picked trading ideas." },
        { q: "How to use AI Top 10 Stocks?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "AI Top 10 Stocks", "applicationCategory": "UtilitiesApplication",
