...
export default function marvel_movie_timeline() {
  ...
  return (
    <ToolLayout
      ...
      desc="Complete Marvel watch order & phase guide."
      icon="🎬" iconBg="rgba(244,63,94,0.08)"
      category="entertainment" slug="marvel-movie-timeline"
      faq={[
        { q: "What is MCU Movie Timeline?", a: "MCU Movie Timeline is a free online tool by UpTools. Complete Marvel watch order & phase guide." },
        { q: "How to use MCU Movie Timeline?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "MCU Movie Timeline", "applicationCategory": "UtilitiesApplication",
