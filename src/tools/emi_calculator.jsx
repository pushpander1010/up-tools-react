...
export default function emi_calculator() {
  return (
    <>
      <Helmet>
        <title>EMI Calculator | UpTools</title>
        <meta name="description" content="Plan monthly loan repayments." />
        <link rel="canonical" href="https://www.uptools.in/emi-calculator/" />
        <meta property="og:title" content="EMI Calculator | UpTools" />
        <meta property="og:description" content="Plan monthly loan repayments." />
      </Helmet>
