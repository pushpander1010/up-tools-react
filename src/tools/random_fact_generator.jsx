...
export default function random_fact_generator() {
  ...
  return (
    <ToolLayout
      ...
      desc="300+ fun facts from science, history, nature & more."
      icon="🎮" iconBg="rgba(244,63,94,0.08)"
      category="fun" slug="random-fact-generator"
      faq={[
        { q: "What is Random Fact Generator?", a: "Random Fact Generator is a free online tool by UpTools. 300+ fun facts from science, history, nature & more." },
        { q: "How to use Random Fact Generator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Random Fact Generator", "applicationCategory": "UtilitiesApplication",
