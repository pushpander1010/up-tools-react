  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Prettify and validate JSON payloads." />
        <link rel="canonical" href="https://www.uptools.in/json-formatter/" />
        <meta property="og:title" content="JSON Formatter | UpTools" />
        <meta property="og:description" content="Prettify and validate JSON payloads." />
      </Helmet>
      ...
      <section className="glass p-6 mb-6" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.08), rgba(17,24,39,0.6))', borderColor: 'rgba(99,102,241,0.2)' }}>
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">Prettify and validate JSON payloads.</p>
          </div>
        </div>
