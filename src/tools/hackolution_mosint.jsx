...
export default function hackolution_mosint() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/JpIwxdfS2fQ/hqdefault.jpg" />
      </Helmet>
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshots" subtitle="Mosint in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/JpIwxdfS2fQ/hqdefault.jpg" alt="Mosint scanning an email address in the terminal" width="1076" height="1296"
