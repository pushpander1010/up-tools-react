...
export default function cbse_class_12_result() {
  ...
  return (
    <ToolLayout
      ...
      desc="Use official result links and analyze Class 12 marks locally."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="cbse-class-12-result"
      faq={[
        { q: "What is CBSE Class 12 Result Checker?", a: "CBSE Class 12 Result Checker is a free online tool by UpTools. Use official result links and analyze Class 12 marks locally." },
        { q: "How to use CBSE Class 12 Result Checker?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "CBSE Class 12 Result Checker", "applicationCategory": "UtilitiesApplication",
