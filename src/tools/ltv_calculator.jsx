...
export default function ltv_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Loan to Value ratio for home loans."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="ltv-calculator"
      faq={[
        { q: "What is LTV Calculator?", a: "LTV Calculator is a free online tool by UpTools. Loan to Value ratio for home loans." },
        { q: "How to use LTV Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "LTV Calculator", "applicationCategory": "UtilitiesApplication",
