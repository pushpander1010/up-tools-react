...
export default function ai_prompts() {
  ...
  return (
    <ToolLayout
      ...
      desc="Curated prompts for design, SEO and resumes."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="ai-prompts"
      faq={[
        { q: "What is AI Prompts Library?", a: "AI Prompts Library is a free online tool by UpTools. Curated prompts for design, SEO and resumes." },
        { q: "How to use AI Prompts Library?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
