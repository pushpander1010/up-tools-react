...
export default function aimakerich_markets_today() {
  return (
    <ToolLayout
      ...
      schema={schema}
      faq={[
        { q: "What are today Nifty and Sensex key levels?", a: "See the levels section above for spot price, support, resistance, and the key level for Nifty, Bank Nifty, and Sensex for 12 August 2026." },
        { q: "Which stocks are in focus today?", a: "Check the stocks to watch section above for analyst picks with buy price, target, and stop loss for 12 August 2026." },
