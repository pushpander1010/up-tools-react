...
export default function hackolution_ddos() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/4G1FpK9HWz8/hqdefault.jpg" />
      </Helmet>
      ...
      <Section id="video" icon="🎬" title="Video Tutorial" subtitle="Watch the HNCKER walkthrough">
        <div className="max-w-3xl mx-auto">
          ...
          <video
            src="https://i.ytimg.com/vi/4G1FpK9HWz8/hqdefault.jpg"
            controls
            preload="none"
            playsInline
...
# [HIT] All threads exhausted`}
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="The DDoS attack layers in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/4G1FpK9HWz8/hqdefault.jpg" alt="The three DDoS attack layers — volumetric, protocol, and application — typed in a terminal"
