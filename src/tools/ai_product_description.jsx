...
export default function ai_product_description() {
  ...
  return (
    <ToolLayout
      ...
      desc="Write SEO-optimized product descriptions for Amazon, Shopify & more."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="ai-product-description"
      faq={[
        { q: "What is AI Product Description Generator?", a: "AI Product Description Generator is a free online tool by UpTools. Write SEO-optimized product descriptions for Amazon, Shopify & more." },
        { q: "How to use AI Product Description Generator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
