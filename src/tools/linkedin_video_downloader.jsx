...
export default function linkedin_video_downloader() {
  ...
  return (
    <ToolLayout
      ...
      desc="Download LinkedIn videos from posts, articles, and courses."
      icon="📱" iconBg="rgba(236,72,153,0.08)"
      category="social" slug="linkedin-video-downloader"
      faq={[
        { q: "What is LinkedIn Video Downloader?", a: "LinkedIn Video Downloader is a free online tool by UpTools. Download LinkedIn videos from posts, articles, and courses." },
        { q: "How to use LinkedIn Video Downloader?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
