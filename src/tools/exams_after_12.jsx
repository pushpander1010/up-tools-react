...
export default function exams_after_12() {
  ...
  return (
    <ToolLayout
      ...
      desc="Compare JEE, NEET, CUET, CLAT, NDA, design entrances, and more after Class 12."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="exams-after-12"
      faq={[
        { q: "What is Entrance Exams After 12?", a: "Entrance Exams After 12 is a free online tool by UpTools. Compare JEE, NEET, CUET, CLAT, NDA, design entrances, and more after Class 12." },
        { q: "How to use Entrance Exams After 12?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Entrance Exams After 12", "applicationCategory": "UtilitiesApplication",
