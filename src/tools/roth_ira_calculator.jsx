...
export default function roth_ira_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate tax-free retirement savings with Roth IRA."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="roth-ira-calculator"
      faq={[
        { q: "What is Roth IRA Calculator?", a: "Roth IRA Calculator is a free online tool by UpTools. Calculate tax-free retirement savings with Roth IRA." },
        { q: "How to use Roth IRA Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Roth IRA Calculator", "applicationCategory": "UtilitiesApplication",
