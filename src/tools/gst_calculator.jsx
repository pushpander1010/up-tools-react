...
export default function gst_calculator() {
  return (
    <>
      <Helmet>
        <title>GST Calculator | UpTools</title>
        <meta name="description" content="Add or remove GST in a click." />
        <link rel="canonical" href="https://www.uptools.in/gst-calculator/" />
        <meta property="og:title" content="GST Calculator | UpTools" />
        <meta property="og:description" content="Add or remove GST in a click." />
      </Helmet>
      ...
      <section className="glass p-6 mb-6" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.08), rgba(17,24,39,0.6))', borderColor: 'rgba(99,102,241,0.2)' }}>
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">Add or remove GST in a click.</p>
          </div>
        </div>
