...
export default function rawcv_resume_builder() {
  ...
  return (
    <ToolLayout
      ...
      desc="Build an ATS-friendly resume with AI. Free, no login, no watermark."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="rawcv-resume-builder"
      faq={[
        { q: "What is AI Resume Builder (rawcv)?", a: "AI Resume Builder (rawcv) is a free online tool by UpTools. Build an ATS-friendly resume with AI. Free, no login, no watermark." },
        { q: "How to use AI Resume Builder (rawcv)?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
