...
export default function meeting_scheduler() {
  ...
  return (
    <ToolLayout
      ...
      desc="Find best meeting times across timezones."
      icon="🌐" iconBg="rgba(14,165,233,0.08)"
      category="networking" slug="meeting-scheduler"
      faq={[
        { q: "What is Meeting Scheduler?", a: "Meeting Scheduler is a free online tool by UpTools. Find best meeting times across timezones." },
        { q: "How to use Meeting Scheduler?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
