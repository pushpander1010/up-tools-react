...
export default function hackolution_seeker() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/cpQo8hKoql0/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/cpQo8hKoql0" title="Seeker GPS Tracking — Track a Phone With One Link — HNCKER"
          ...
          <div className="flex gap-2 flex-wrap mt-3">
            <a href="https://www.youtube.com/watch?v=cpQo8hKoql0" target="_blank" rel="noopener noreferrer"
...
[OK] Device info collected`} />
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="Seeker in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/cpQo8hKoql0/hqdefault.jpg" alt="seeker video tutorial thumbnail"
            width="480" height="360" className="w-full h-auto object-contain" loading="lazy" />
