...
export default function ai_grammar_checker() {
  ...
  return (
    <ToolLayout
      ...
      desc="Fix grammar, spelling & punctuation instantly."
      icon="🤖" iconBg="rgba(168,85,247,0.08)"
      category="ai" slug="ai-grammar-checker"
      faq={[
        { q: "What is AI Grammar Checker?", a: "AI Grammar Checker is a free online tool by UpTools. Fix grammar, spelling & punctuation instantly." },
        { q: "How to use AI Grammar Checker?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
