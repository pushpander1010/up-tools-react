...
export default function wifi_router() {
  ...
  return (
    <ToolLayout
      ...
      desc="Find default passwords, Wi-Fi QR & vendors."
      icon="📶" iconBg="rgba(14,165,233,0.08)"
      category="wifi" slug="wifi-router"
      faq={[
        { q: "What is WiFi Router Tools?", a: "WiFi Router Tools is a free online tool by UpTools. Find default passwords, Wi-Fi QR & vendors." },
        { q: "How to use WiFi Router Tools?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "WiFi Router Tools", "applicationCategory": "UtilitiesApplication",
