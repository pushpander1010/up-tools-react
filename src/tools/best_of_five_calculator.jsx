...
export default function best_of_five_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Find your best-of-five percentage and included subjects."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="best-of-five-calculator"
      faq={[
        { q: "What is Best of Five Calculator?", a: "Best of Five Calculator is a free online tool by UpTools. Find your best-of-five percentage and included subjects." },
        { q: "How to use Best of Five Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Best of Five Calculator", "applicationCategory": "UtilitiesApplication",
