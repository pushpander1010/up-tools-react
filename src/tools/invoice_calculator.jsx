...
export default function invoice_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate invoice subtotal, discount, tax and total due."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="invoice-calculator"
      faq={[
        { q: "What is Invoice Calculator?", a: "Invoice Calculator is a free online tool by UpTools. Calculate invoice subtotal, discount, tax and total due." },
        { q: "How to use Invoice Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Invoice Calculator", "applicationCategory": "UtilitiesApplication",
