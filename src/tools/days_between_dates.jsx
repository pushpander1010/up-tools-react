...
export default function days_between_dates() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate days, weeks, months between two dates."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="days-between-dates"
      faq={[
        { q: "What is Days Between Dates?", a: "Days Between Dates is a free online tool by UpTools. Calculate days, weeks, months between two dates." },
        { q: "How to use Days Between Dates?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Days Between Dates", "applicationCategory": "UtilitiesApplication",
