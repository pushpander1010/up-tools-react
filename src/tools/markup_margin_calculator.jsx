...
export default function markup_margin_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Convert cost, sale price, markup, margin and gross profit."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="markup-margin-calculator"
      faq={[
        { q: "What is Markup vs Margin Calculator?", a: "Markup vs Margin Calculator is a free online tool by UpTools. Convert cost, sale price, markup, margin and gross profit." },
        { q: "How to use Markup vs Margin Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Markup vs Margin Calculator", "applicationCategory": "UtilitiesApplication",
