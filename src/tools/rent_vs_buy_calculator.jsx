...
export default function rent_vs_buy_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Compare renting vs buying a home over time."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="rent-vs-buy-calculator"
      faq={[
        { q: "What is Rent vs Buy Calculator?", a: "Rent vs Buy Calculator is a free online tool by UpTools. Compare renting vs buying a home over time." },
        { q: "How to use Rent vs Buy Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Rent vs Buy Calculator", "applicationCategory": "UtilitiesApplication",
