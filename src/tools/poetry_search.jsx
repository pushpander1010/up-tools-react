...
export default function poetry_search() {
  ...
  return (
    <ToolLayout
      title="Poetry Search"
      desc="Search thousands of poems by title, author, or line."
      icon="🔧" iconBg="rgba(245,158,11,0.08)"
      category="tools" slug="poetry-search"
      faq={[
        { q: "What is Poetry Search?", a: "Poetry Search is a free online tool by UpTools. Search thousands of poems by title, author, or line." },
        { q: "How to use Poetry Search?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
