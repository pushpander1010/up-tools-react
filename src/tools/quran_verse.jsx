...
export default function quran_verse() {
  ...
  return (
    <ToolLayout
      ...
      desc="Read Quran in Arabic & English by Surah."
      icon="🔧" iconBg="rgba(245,158,11,0.08)"
      category="tools" slug="quran-verse"
      faq={[
        { q: "What is Quran Verse Lookup?", a: "Quran Verse Lookup is a free online tool by UpTools. Read Quran in Arabic & English by Surah." },
        { q: "How to use Quran Verse Lookup?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Quran Verse Lookup", "applicationCategory": "UtilitiesApplication",
