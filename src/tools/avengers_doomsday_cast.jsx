...
export default function avengers_doomsday_cast() {
  ...
  return (
    <ToolLayout
      title="Doomsday Cast"
      desc="Confirmed & rumored Avengers Doomsday cast."
      icon="🎬" iconBg="rgba(244,63,94,0.08)"
      category="entertainment" slug="avengers-doomsday-cast"
      faq={[
        { q: "What is Doomsday Cast?", a: "Doomsday Cast is a free online tool by UpTools. Confirmed & rumored Avengers Doomsday cast." },
        { q: "How to use Doomsday Cast?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Doomsday Cast", "applicationCategory": "UtilitiesApplication",
