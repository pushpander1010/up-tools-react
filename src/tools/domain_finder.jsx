...
export default function domain_finder() {
  ...
  return (
    <ToolLayout
      ...
      desc="Discover available domains instantly."
      icon="🌐" iconBg="rgba(14,165,233,0.08)"
      category="networking" slug="domain-finder"
      faq={[
        { q: "What is Domain Name Finder?", a: "Domain Name Finder is a free online tool by UpTools. Discover available domains instantly." },
        { q: "How to use Domain Name Finder?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Domain Name Finder", "applicationCategory": "UtilitiesApplication",
