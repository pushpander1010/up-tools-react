...
export default function html_preview() {
  ...
  return (
    <ToolLayout
      title="HTML Preview"
      desc="HTML Preview - write HTML and see a live preview instantly. Edit markup and CSS, render in real time, online free. Free online, no sign-up. Works on any device."
      ...
      faq={[
        ...
        { q: "How do I use this HTML Preview online free?", a: "Enter your input above, customize the options, and copy or save the result. Free with no sign-up." },
        { q: "How do I save my result?", a: "Click the copy or download button on your result to save it. Free with no sign-up." },
        { q: "Can I use it more than once?", a: "Yes, unlimited free use. Generate as many results as you need, on any device." },
        { q: "Is this HTML Preview free?", a: "Yes, completely free with no sign-up. Use it unlimited times online on any device." },
      ]}
      howItWorks={[
