...
export default function pan_aadhaar_link_status() {
  ...
  return (
    <ToolLayout
      ...
      desc="Validate format and open the official status page."
      icon="📋" iconBg="rgba(245,158,11,0.08)"
      category="tax" slug="pan-aadhaar-link-status"
      faq={[
        { q: "What is PAN–Aadhaar Link Status Guide?", a: "PAN–Aadhaar Link Status Guide is a free online tool by UpTools. Validate format and open the official status page." },
        { q: "How to use PAN–Aadhaar Link Status Guide?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "PAN–Aadhaar Link Status Guide", "applicationCategory": "UtilitiesApplication",
