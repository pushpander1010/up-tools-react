...
export default function food_randomizer() {
  ...
  return (
    <ToolLayout
      ...
      desc="Discover random dishes from around the world."
      icon="🎮" iconBg="rgba(244,63,94,0.08)"
      category="fun" slug="food-randomizer"
      faq={[
        { q: "What is Food Randomizer?", a: "Food Randomizer is a free online tool by UpTools. Discover random dishes from around the world." },
        { q: "How to use Food Randomizer?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
