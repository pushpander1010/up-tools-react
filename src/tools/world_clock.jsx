...
export default function world_clock() {
  ...
  return (
    <ToolLayout
      title="World Clock"
      desc="Check time in 200+ cities worldwide."
      icon="🌐" iconBg="rgba(14,165,233,0.08)"
      category="networking" slug="world-clock"
      faq={[
        { q: "What is World Clock?", a: "World Clock is a free online tool by UpTools. Check time in 200+ cities worldwide." },
        { q: "How to use World Clock?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
