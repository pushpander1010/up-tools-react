...
export default function multi_currency_converter() {
  ...
  return (
    <ToolLayout
      ...
      desc="Convert 150+ currencies with real-time rates."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="multi-currency-converter"
      faq={[
        { q: "What is Multi-Currency Converter?", a: "Multi-Currency Converter is a free online tool by UpTools. Convert 150+ currencies with real-time rates." },
        { q: "How to use Multi-Currency Converter?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Multi-Currency Converter", "applicationCategory": "UtilitiesApplication",
