...
export default function color_tool() {
  ...
  return (
    <ToolLayout
      ...
      desc="Pick colors, convert HEX/RGB/HSL, generate palettes."
      icon="🔧" iconBg="rgba(245,158,11,0.08)"
      category="tools" slug="color-tool"
      faq={[
        { q: "What is Color Picker & Converter?", a: "Color Picker & Converter is a free online tool by UpTools. Pick colors, convert HEX/RGB/HSL, generate palettes." },
        { q: "How to use Color Picker & Converter?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Color Picker & Converter", "applicationCategory": "UtilitiesApplication",
