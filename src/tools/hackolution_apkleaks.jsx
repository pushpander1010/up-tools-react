...
export default function hackolution_apkleaks() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/7e9CTa9sVmE/hqdefault.jpg" />
      </Helmet>
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshots" subtitle="APKLeaks in action">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
            <img src="https://i.ytimg.com/vi/7e9CTa9sVmE/hqdefault.jpg" alt="APKLeaks scanning an APK file in the terminal" width="640" height="502"
              className="w-full h-auto object-contain" loading="lazy" />
            <figcaption className="px-4 py-2 text-xs text-slate-400">Scanning an APK with APKLeaks</figcaption>
          </figure>
          <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
            <img src="https://i.ytimg.com/vi/7e9CTa9sVmE/hqdefault.jpg" alt="APKLeaks terminal output showing URLs and secrets" width="639" height="506"
              className="w-full h-auto object-contain" loading="lazy" />
