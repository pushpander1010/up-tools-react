...
export default function hackolution_nmap() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/rzjEnnUSBOU/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/rzjEnnUSBOU" title="Nmap Full Tutorial — Network Scanning Explained Step by Step — HNCKER"
          ...
          <div className="flex gap-2 flex-wrap mt-3">
            <a href="https://www.youtube.com/watch?v=rzjEnnUSBOU" target="_blank" rel="noopener noreferrer"
  ...
  { i: "🔍", t: "Scan yourself", d: "If Nmap sees it, attackers can too." },
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="Nmap in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/rzjEnnUSBOU/hqdefault.jpg" alt="nmap video tutorial thumbnail" width="480" height="360"
      ...
      <Section id="resources" icon="🔗" title="Resources" subtitle="Official links">
        <div className="space-y-2">
          {[["📚", "Official Nmap docs", "https://nmap.org/docs.html"], ["📖", "Nmap cheat sheet", "https://nmap.org/book/man.html"], ["📸", "HACKOLUTION Instagram", "https://www.instagram.com/hackolution"]].map(([i, label, href]) => (
