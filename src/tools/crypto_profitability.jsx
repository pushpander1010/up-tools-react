...
export default function crypto_profitability() {
  ...
  return (
    <ToolLayout
      ...
      desc="Gauge mining and trading profits."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="crypto-profitability"
      faq={[
        { q: "What is Crypto Profitability?", a: "Crypto Profitability is a free online tool by UpTools. Gauge mining and trading profits." },
        { q: "How to use Crypto Profitability?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Crypto Profitability", "applicationCategory": "UtilitiesApplication",
