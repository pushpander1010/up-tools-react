...
export default function cbse_percentage_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate Class 12 percentage from subject-wise marks instantly."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="cbse-percentage-calculator"
      faq={[
        { q: "What is CBSE Percentage Calculator?", a: "CBSE Percentage Calculator is a free online tool by UpTools. Calculate Class 12 percentage from subject-wise marks instantly." },
        { q: "How to use CBSE Percentage Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "CBSE Percentage Calculator", "applicationCategory": "UtilitiesApplication",
