...
export default function india_college_rankings() {
  ...
  return (
    <ToolLayout
      ...
      desc="Explore top colleges and universities across India with rankings."
      icon="📝" iconBg="rgba(99,102,241,0.08)"
      category="text" slug="india-college-rankings"
      faq={[
        { q: "What is India College Rankings?", a: "India College Rankings is a free online tool by UpTools. Explore top colleges and universities across India with rankings." },
        { q: "How to use India College Rankings?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "India College Rankings", "applicationCategory": "UtilitiesApplication",
