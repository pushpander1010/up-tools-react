...
export default function youtube_audio_downloader() {
  ...
  return (
    <ToolLayout
      ...
      desc="Download YouTube audio as MP3 in high quality."
      icon="📱" iconBg="rgba(236,72,153,0.08)"
      category="social" slug="youtube-audio-downloader"
      faq={[
        { q: "What is YouTube Audio Downloader?", a: "YouTube Audio Downloader is a free online tool by UpTools. Download YouTube audio as MP3 in high quality." },
        { q: "How to use YouTube Audio Downloader?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "YouTube Audio Downloader", "applicationCategory": "UtilitiesApplication",
