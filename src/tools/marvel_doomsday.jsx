...
export default function marvel_doomsday() {
  ...
  return (
    <ToolLayout
      ...
      desc="Release date, cast & Multiverse Saga guide."
      icon="🎬" iconBg="rgba(244,63,94,0.08)"
      category="entertainment" slug="marvel-doomsday"
      faq={[
        { q: "What is Marvel Doomsday 2026?", a: "Marvel Doomsday 2026 is a free online tool by UpTools. Release date, cast & Multiverse Saga guide." },
        { q: "How to use Marvel Doomsday 2026?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Marvel Doomsday 2026", "applicationCategory": "UtilitiesApplication",
