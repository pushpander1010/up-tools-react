...
export default function pinterest_video_downloader() {
  ...
  return (
    <ToolLayout
      ...
      desc="Download Pinterest pins and videos in original quality."
      icon="📱" iconBg="rgba(236,72,153,0.08)"
      category="social" slug="pinterest-video-downloader"
      faq={[
        { q: "What is Pinterest Video Downloader?", a: "Pinterest Video Downloader is a free online tool by UpTools. Download Pinterest pins and videos in original quality." },
        { q: "How to use Pinterest Video Downloader?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
