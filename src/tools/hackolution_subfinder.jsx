...
export default function hackolution_subfinder() {
  return (
    <ToolLayout
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/E-6uJ0j3xMo" title="Subfinder Tutorial — Find Every Subdomain of a Website — HNCKER"
...
# api.dev.example.com`} />
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="Subfinder in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/E-6uJ0j3xMo/hqdefault.jpg" alt="subfinder video tutorial thumbnail" width="480" height="360"
