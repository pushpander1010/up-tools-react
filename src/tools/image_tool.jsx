...
export default function image_tool() {
  ...
  return (
    <ToolLayout
      title="Image Tool"
      desc="Remove backgrounds and apply filters."
      icon="🖼️" iconBg="rgba(168,85,247,0.08)"
      category="images" slug="image-tool"
      faq={[
        { q: "What is Image Tool?", a: "Image Tool is a free online tool by UpTools. Remove backgrounds and apply filters." },
        { q: "How to use Image Tool?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Image Tool", "applicationCategory": "UtilitiesApplication",
