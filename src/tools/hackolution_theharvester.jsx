...
export default function hackolution_theharvester() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/dPdpEpzSXAM/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/dPdpEpzSXAM" title="What is theHarvester? OSINT Email and Domain Tool — HNCKER"
          ...
          <div className="flex gap-2 flex-wrap mt-3">
            <a href="https://www.youtube.com/watch?v=dPdpEpzSXAM" target="_blank" rel="noopener noreferrer"
  ...
  { i: "👁️", t: "Google yourself", d: "What you find, attackers find." },
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="theHarvester in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/dPdpEpzSXAM/hqdefault.jpg" alt="theharvester video tutorial thumbnail" width="480" height="360"
      ...
      <Section id="resources" icon="🔗" title="Resources" subtitle="Official links">
        <div className="space-y-2">
          {[["📚", "theHarvester on GitHub", "https://github.com/laramies/theHarvester"], ["📖", "crt.sh certificate search", "https://crt.sh/"], ["📸", "HACKOLUTION Instagram", "https://www.instagram.com/hackolution"]].map(([i, label, href]) => (
