...
export default function color_palette_generator_pro() {
  ...
  return (
    <ToolLayout
      ...
      desc="Create beautiful color schemes."
      icon="🖼️" iconBg="rgba(168,85,247,0.08)"
      category="images" slug="color-palette-generator-pro"
      faq={[
        { q: "What is Color Palette Pro?", a: "Color Palette Pro is a free online tool by UpTools. Create beautiful color schemes." },
        { q: "How to use Color Palette Pro?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Color Palette Pro", "applicationCategory": "UtilitiesApplication",
