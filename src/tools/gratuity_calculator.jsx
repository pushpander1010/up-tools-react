...
export default function gratuity_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate gratuity amount for employees."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="gratuity-calculator"
      faq={[
        { q: "What is Gratuity Calculator?", a: "Gratuity Calculator is a free online tool by UpTools. Calculate gratuity amount for employees." },
        { q: "How to use Gratuity Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Gratuity Calculator", "applicationCategory": "UtilitiesApplication",
