  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Create QR codes for links and text." />
        <link rel="canonical" href="https://www.uptools.in/qr-generator/" />
        <meta property="og:title" content="QR Code Generator | UpTools" />
        <meta property="og:description" content="Create QR codes for links and text." />
      </Helmet>
      ...
      <section className="glass p-6 mb-6" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.08), rgba(17,24,39,0.6))', borderColor: 'rgba(99,102,241,0.2)' }}>
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">Create QR codes for links and text.</p>
          </div>
        </div>
