...
export default function hackolution_aircrack() {
  return (
    <ToolLayout
    ...
    >
      <Helmet>
        ...
        <meta property="og:image" content="https://i.ytimg.com/vi/VXBjcn9Yujw/hqdefault.jpg" />
      </Helmet>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-xl overflow-hidden border border-white/10" style={{ background: '#000' }}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}>
              <iframe src="https://www.youtube.com/embed/VXBjcn9Yujw" title="Aircrack-ng Tutorial — WiFi Cracking Suite Explained — HNCKER"
          ...
          <div className="flex gap-2 flex-wrap mt-3">
            <a href="https://www.youtube.com/watch?v=VXBjcn9Yujw" target="_blank" rel="noopener noreferrer"
  ...
  { i: "🔄", t: "Update router", d: "Patch the firmware yearly." },
      ...
      <Section id="screenshots" icon="🖼️" title="Screenshot" subtitle="Aircrack-ng in action">
        <figure className="rounded-xl overflow-hidden border border-white/10" style={{ background: 'rgba(0,0,0,0.3)' }}>
          <img src="https://i.ytimg.com/vi/VXBjcn9Yujw/hqdefault.jpg" alt="aircrack video tutorial thumbnail" width="480" height="360"
      ...
      <Section id="resources" icon="🔗" title="Resources" subtitle="Official links">
        <div className="space-y-2">
          {[["📚", "Aircrack-ng docs", "https://www.aircrack-ng.org/documentation.html"], ["📖", "Kali wireless guide", "https://www.kali.org/docs/"], ["📸", "HACKOLUTION Instagram", "https://www.instagram.com/hackolution"]].map(([i, label, href]) => (
