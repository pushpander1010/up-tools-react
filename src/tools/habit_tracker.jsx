...
export default function habit_tracker() {
  ...
  return (
    <ToolLayout
      title="Habit Tracker"
      desc="Track daily habits and build streaks."
      icon="❤️" iconBg="rgba(239,68,68,0.08)"
      category="health" slug="habit-tracker"
      faq={[
        { q: "What is Habit Tracker?", a: "Habit Tracker is a free online tool by UpTools. Track daily habits and build streaks." },
        { q: "How to use Habit Tracker?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Habit Tracker", "applicationCategory": "UtilitiesApplication",
