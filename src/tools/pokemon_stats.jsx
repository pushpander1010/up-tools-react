...
export default function pokemon_stats() {
  ...
  return (
    <ToolLayout
      ...
      desc="Search all Pokemon base stats and export CSV."
      icon="🎮" iconBg="rgba(244,63,94,0.08)"
      category="fun" slug="pokemon-stats"
      faq={[
        { q: "What is Pokemon Stats Directory?", a: "Pokemon Stats Directory is a free online tool by UpTools. Search all Pokemon base stats and export CSV." },
        { q: "How to use Pokemon Stats Directory?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Pokemon Stats Directory", "applicationCategory": "UtilitiesApplication",
