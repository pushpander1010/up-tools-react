...
export default function passphrase_generator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Diceware-style strong memorable passphrases."
      icon="🔒" iconBg="rgba(239,68,68,0.08)"
      category="security" slug="passphrase-generator"
      faq={[
        { q: "What is Passphrase Generator?", a: "Passphrase Generator is a free online tool by UpTools. Diceware-style strong memorable passphrases." },
        { q: "How to use Passphrase Generator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Passphrase Generator", "applicationCategory": "UtilitiesApplication",
