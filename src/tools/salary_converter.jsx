...
export default function salary_converter() {
  ...
  return (
    <ToolLayout
      ...
      desc="Convert hourly, daily, weekly, monthly and annual pay fast."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="salary-converter"
      faq={[
        { q: "What is Salary Converter?", a: "Salary Converter is a free online tool by UpTools. Convert hourly, daily, weekly, monthly and annual pay fast." },
        { q: "How to use Salary Converter?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "Salary Converter", "applicationCategory": "UtilitiesApplication",
