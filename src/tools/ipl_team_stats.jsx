...
export default function ipl_team_stats() {
  ...
  return (
    <ToolLayout
      ...
      desc="All-time IPL records, wins, titles and performance stats."
      icon="🏏" iconBg="rgba(59,130,246,0.08)"
      category="cricket" slug="ipl-team-stats"
      faq={[
        { q: "What is IPL Team Statistics?", a: "IPL Team Statistics is a free online tool by UpTools. All-time IPL records, wins, titles and performance stats." },
        { q: "How to use IPL Team Statistics?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "IPL Team Statistics", "applicationCategory": "UtilitiesApplication",
