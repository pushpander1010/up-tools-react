...
export default function pin_code_finder() {
  ...
  return (
    <ToolLayout
      ...
      desc="Find post office, district & state by PIN code. Bulk lookup + CSV."
      icon="🏦" iconBg="rgba(99,102,241,0.08)"
      category="banking" slug="pin-code-finder"
      faq={[
        { q: "What is PIN Code Finder India?", a: "PIN Code Finder India is a free online tool by UpTools. Find post office, district & state by PIN code. Bulk lookup + CSV." },
        { q: "How to use PIN Code Finder India?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "PIN Code Finder India", "applicationCategory": "UtilitiesApplication",
