...
export default function roi_calculator() {
  ...
  return (
    <ToolLayout
      ...
      desc="Calculate return on investment instantly."
      icon="💰" iconBg="rgba(34,197,94,0.08)"
      category="finance" slug="roi-calculator"
      faq={[
        { q: "What is ROI Calculator?", a: "ROI Calculator is a free online tool by UpTools. Calculate return on investment instantly." },
        { q: "How to use ROI Calculator?", a: "Simply enter your input and click Calculate to get instant results." },
      ]}
      howItWorks={[
      ...
      schema={{
        ...
        "name": "ROI Calculator", "applicationCategory": "UtilitiesApplication",
