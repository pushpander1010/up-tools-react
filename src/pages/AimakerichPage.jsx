...
const bulletins = [
  { slug: 'markets-today', date: '14 August 2026', icon: '📰', mood: 'Nifty dips 3rd day · DIIs cushion', desc: 'Nifty 24,396 (-0.16%) · Sensex 78,080 +0.15% · Bank Nifty 57,635 · July CPI 4.45% 19-mo high · crude near $90 · DIIs +₹4,353 Cr · AIA Eng + Cochin Shipyard.', accent: 'linear-gradient(135deg, rgba(0,200,180,0.16), rgba(251,191,36,0.07))' },
  { slug: 'markets-today-2026-08-13', date: '13 August 2026', icon: '📰', mood: 'Banks firm · crude caps', desc: 'Nifty 24,436 · Bank Nifty 57,885 firm · crude past $88 on Hormuz · Grasim Q1 +51% · 5 stocks to watch.', accent: 'linear-gradient(135deg, rgba(0,200,180,0.16), rgba(251,191,36,0.07))' },
