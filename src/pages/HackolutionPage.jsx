...
const tools = [
  ...
  { slug: 'pegasus', name: 'Pegasus Pro', img: '/assets/tools/pegasus/pegasus_logo.png', alt: 'Pegasus Pro Android pentesting toolkit logo', desc: 'Python menu toolkit for Android pentests — WiFi tools, scanner, payload gen.', tag: 'Android pentest', accent: 'linear-gradient(135deg, rgba(0,255,65,0.2), rgba(6,182,212,0.08))' },
  { slug: 'rooting', name: 'Root Android', img: '/assets/tools/rooting/rooting_logo.png', alt: 'Root Android guide logo', desc: 'Step-by-step guide to root your own Android with Magisk — Pixel, Samsung, Xiaomi, OnePlus, Motorola.', tag: 'How-to guide', accent: 'linear-gradient(135deg, rgba(0,255,65,0.2), rgba(6,182,212,0.08))' },
  { slug: 'ddos', name: 'How Hackers DDoS', img: '/assets/tools/ddos/ddos_logo.png', alt: 'DDoS attack layers guide logo', desc: 'Understand the 3 professional DDoS layers — volumetric, protocol, application — and how to defend against them.', tag: 'How-to guide', accent: 'linear-gradient(135deg, rgba(0,255,65,0.2), rgba(6,182,212,0.08))' },
  { slug: 'seeker', name: 'Seeker', img: '/assets/tools/seeker/seeker_logo.png', alt: 'Seeker smartphone locator logo', desc: 'Understand how Seeker locates a smartphone via a location-permission page — and how to protect yourself.', tag: 'GPS locator', accent: 'linear-gradient(135deg, rgba(0,255,65,0.2), rgba(6,182,212,0.08))' },
  { slug: 'vulns', name: 'Find Vulnerabilities', img: '/assets/tools/vulns/vulns_poster.jpg', alt: 'How hackers find vulnerabilities 6-step method logo', desc: 'The 6-step method hackers use: recon, scan, enumerate, map, find the bug, exploit — explained.', tag: 'How-to guide', accent: 'linear-gradient(135deg, rgba(0,255,65,0.2), rgba(6,182,212,0.08))' },
  ...
  { slug: 'netcat', name: 'Netcat', img: '/assets/tools/netcat/netcat_logo.png', alt: 'Netcat Swiss army knife networking tool logo', desc: 'The hacker Swiss army knife — port checks, banners, chat, file transfer, shells.', tag: 'Swiss army knife', accent: 'linear-gradient(135deg, rgba(0,255,65,0.2), rgba(0,200,180,0.08))' },
  { slug: 'nmap', name: 'Nmap', img: '/assets/tools/nmap/nmap_logo.png', alt: 'Nmap network scanner logo', desc: 'Map networks: host discovery, SYN scans, service and OS detection.', tag: 'Network scanner', accent: 'linear-gradient(135deg, rgba(0,255,65,0.2), rgba(0,200,180,0.08))' },
  ...
  { slug: 'hydra', name: 'Hydra', img: '/assets/tools/hydra/hydra_logo.png', alt: 'Hydra login brute-forcer logo', desc: 'Brute-force SSH, FTP and web logins on lab VMs with wordlists.', tag: 'Brute-forcer', accent: 'linear-gradient(135deg, rgba(0,212,255,0.2), rgba(0,200,180,0.08))' },
  { slug: 'burp', name: 'Burp Suite', img: '/assets/tools/burp/burp_logo.png', alt: 'Burp Suite web proxy logo', desc: 'Intercept and replay web traffic — proxy, Repeater, Intruder.', tag: 'Web proxy', accent: 'linear-gradient(135deg, rgba(255,136,0,0.2), rgba(0,200,180,0.08))' },
  { slug: 'wireshark', name: 'Wireshark', img: '/assets/tools/wireshark/wireshark_logo.png', alt: 'Wireshark packet analyzer logo', desc: 'Capture and read packets — filters, TCP streams, TLS vs plaintext.', tag: 'Packet analyzer', accent: 'linear-gradient(135deg, rgba(0,200,255,0.2), rgba(0,200,180,0.08))' },
  { slug: 'gobuster', name: 'Gobuster', img: '/assets/tools/gobuster/gobuster_logo.png', alt: 'Gobuster directory fuzzer logo', desc: 'Find hidden pages, files and subdomains with dir and dns modes.', tag: 'Directory fuzzer', accent: 'linear-gradient(135deg, rgba(255,51,85,0.2), rgba(0,200,180,0.08))' },
  { slug: 'theharvester', name: 'theHarvester', img: '/assets/tools/theharvester/theharvester_logo.png', alt: 'theHarvester OSINT collector logo', desc: 'Harvest emails and subdomains for your domain from public sources.', tag: 'OSINT collector', accent: 'linear-gradient(135deg, rgba(255,204,0,0.2), rgba(0,200,180,0.08))' },
  { slug: 'metasploit', name: 'Metasploit', img: '/assets/tools/metasploit/metasploit_logo.png', alt: 'Metasploit framework logo', desc: 'Exploit lab VMs — msfconsole, exploit + payload, Meterpreter.', tag: 'Exploit framework', accent: 'linear-gradient(135deg, rgba(255,0,51,0.2), rgba(0,200,180,0.08))' },
  { slug: 'john', name: 'John the Ripper', img: '/assets/tools/john/john_logo.png', alt: 'John the Ripper hash cracker logo', desc: 'Crack lab password hashes — wordlists, rules, shadow files.', tag: 'Hash cracker', accent: 'linear-gradient(135deg, rgba(204,204,204,0.2), rgba(0,200,180,0.08))' },
  { slug: 'aircrack', name: 'Aircrack-ng', img: '/assets/tools/aircrack/aircrack_logo.png', alt: 'Aircrack-ng WiFi auditor logo', desc: 'Audit your own WiFi — monitor mode, handshake capture, crack test.', tag: 'WiFi auditor', accent: 'linear-gradient(135deg, rgba(0,255,163,0.2), rgba(0,200,180,0.08))' },
  { slug: 'sherlock', name: 'Sherlock', img: '/assets/tools/sherlock/sherlock_logo.png', alt: 'Sherlock username hunter logo', desc: 'Check your username across 400+ sites and clean your footprint.', tag: 'Username OSINT', accent: 'linear-gradient(135deg, rgba(179,102,255,0.2), rgba(0,200,180,0.08))' },
  { slug: 'holehe', name: 'Holehe', img: '/assets/tools/holehe/holehe_logo.png', alt: 'Holehe email checker logo', desc: 'Check where your email is registered across 120+ sites.', tag: 'Email OSINT', accent: 'linear-gradient(135deg, rgba(255,102,204,0.2), rgba(0,200,180,0.08))' },
  { slug: 'ghunt', name: 'GHunt', img: '/assets/tools/ghunt/ghunt_logo.png', alt: 'GHunt Google OSINT logo', desc: 'See what your Google account leaks — profile, Maps, Photos.', tag: 'Google OSINT', accent: 'linear-gradient(135deg, rgba(66,133,244,0.2), rgba(0,200,180,0.08))' },
...
const ytVideos = [
  { id: 'E-6uJ0j3xMo', title: 'Subfinder Tutorial — Find Every Subdomain (Full Guide) | HACKOLUTION', sub: 'Web recon · subdomain discovery' },
  { id: 'H8dwJpti6jg', title: 'ffuf Tutorial — Find Hidden Pages & Directories (Full Guide) | HACKOLUTION', sub: 'Content discovery · web fuzzing' },
  { id: 'wB-Jvz__0B4', title: 'Hashcat Tutorial — Crack Passwords with GPU (Full Guide) | HACKOLUTION', sub: 'Password recovery · GPU cracking' },
]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Follow HACKOLUTION on Instagram, browse the free security tools, watch our tech videos, and download free Android apps." />
        ...
        <meta property="og:description" content="Follow HACKOLUTION on Instagram, browse the free security tools, watch our tech videos, and download free Android apps." />
        ...
        <meta name="twitter:description" content="Follow HACKOLUTION on Instagram, browse the free security tools, watch our tech videos, and download free Android apps." />
      </Helmet>
      ...
      <div className="relative mb-6 overflow-hidden rounded-3xl border border-neon-border p-8 sm:p-10"
        ...
        <div className="relative flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">No-nonsense hacking, tools, apps & videos.</p>
          </div>
        </div>
      ...
      <div className="glass rounded-3xl p-7 mb-6 flex flex-col sm:flex-row items-center justify-between gap-5"
        ...
        <div>
          ...
          <div className="flex gap-6 mt-2">
            <div className="text-center"><b className="block text-white text-lg">19.5K</b><span className="text-[11px] text-slate-400 uppercase tracking-wider">followers</span></div>
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <a href="https://www.threads.net/@hackolution" target="_blank" rel="noopener" className="glow-btn text-sm px-5 py-2.5 rounded-xl no-underline"
            style={{ background: '#000', border: '1px solid rgba(255,255,255,0.15)' }}>Threads ↗</a>
          <a href="https://t.me/hnckergroup" target="_blank" rel="noopener" className="glow-btn text-sm px-5 py-2.5 rounded-xl no-underline"
      ...
      <div className="glass rounded-3xl mb-6 overflow-hidden" style={{ borderColor: 'rgba(57,255,20,0.1)' }}>
        <div className="px-6 pt-6 pb-4"><h2 className="text-xl font-bold m-0">📱 Our Android Apps</h2><p className="text-xs text-slate-400 mt-1">Free, open, privacy-first — built by HACKOLUTION.</p></div>
        <div className="px-6 pb-6">
          <InfiniteCarousel gap={16}>
            {androidApps.map(app => (
            ...
            {igReels.map((r) => (
              <a key={r.sc} href={`https://www.instagram.com/reel/${r.sc}/`} target="_blank" rel="noopener"
                ...
                <div className="p-3">
                  ...
                  <div className="text-[10px] text-slate-500 uppercase tracking-wider mt-1">@hackolution · {r.views} views</div>
                </div>
              </a>
            ))}
          </InfiniteCarousel>
