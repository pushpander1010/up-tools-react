...
const tools = [
  ...
  },
  {
    slug: 'nuclei',
    name: 'Nuclei',
    img: '/assets/tools/nuclei/nuclei_logo.png',
    alt: 'Nuclei vulnerability scanner logo',
    desc: 'Fast template-driven vulnerability scanner from ProjectDiscovery.',
    tag: 'Vuln scanner',
  ...
  },
  {
    slug: 'hping3',
    name: 'hping3',
    img: '/assets/tools/hping3/hping3_logo.png',
    alt: 'hping3 packet crafting tool logo',
    desc: 'Craft raw TCP/UDP/ICMP packets, scan ports and stress-test firewalls.',
    tag: 'Packet crafting',
    accent: 'linear-gradient(135deg, rgba(0,255,65,0.2), rgba(6,182,212,0.08))',
  },
  {
    slug: 'subfinder',
    name: 'Subfinder',
    img: '/assets/tools/subfinder/subfinder_logo.png',
    alt: 'Subfinder subdomain discovery logo',
    desc: 'Passive subdomain discovery from dozens of public sources.',
    tag: 'Subdomain recon',
  ...
  },
  {
    slug: 'ffuf',
    name: 'ffuf',
    img: '/assets/tools/ffuf/ffuf_logo.png',
    alt: 'ffuf web fuzzer logo',
    desc: 'Fast web fuzzer for content discovery, parameters and login brute force.',
    tag: 'Web fuzzer',
    accent: 'linear-gradient(135deg, rgba(0,255,65,0.2), rgba(0,200,180,0.08))',
  },
  {
    slug: 'hashcat',
    name: 'Hashcat',
    img: '/assets/tools/hashcat/hashcat_logo.png',
    alt: 'Hashcat password cracker logo',
    desc: 'GPU-accelerated password recovery — dictionary, brute-force and rules.',
    ...
    <>
      ...
      <div className="relative mb-6 overflow-hidden rounded-3xl border border-neon-border p-8 sm:p-10"
        ...
        <div className="relative flex flex-wrap gap-2 mt-5">
          ...
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-white/5 border border-white/8 text-slate-300">🛠️ 10 free tools</span>
